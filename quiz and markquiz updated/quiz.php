...
<html lang="en">
 ...
 <nav id="navbar">
		...
		<?php include ('markquiz.php'); ?>
        <form id="appForm" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <fieldset>
                ...
                <p><label for="studentNumber">Student Number</label> 
					...
					<span class="error"><?= $studentNumberErr ?></span>
                </p>
            </fieldset>
            <br>
            ...
            <fieldset>
				...
				<span class="error"><?= $textAnswerErr ?></span>
                </p>
            </fieldset>
            <br>
            ...
            <fieldset>
                ...
                <p> 
                    ...
                    <label for="ARP">ARP</label> 
						...
						<span class="error"><?= $protocolErr ?></span>
                </p>
            </fieldset> 
            <br>
            ...
            <fieldset>
                <p><label for="appName">The most popular subscription streaming services in the world is </label> 
					...
					<span class="error"><?= $appNameErr ?></span>
                </p>
            </fieldset>
            <br>
            ...
            <fieldset>
                ...
                <p>
					...
					<span class="error"><?= $favcolorErr ?></span>
                </p>
            </fieldset>
            <br>
